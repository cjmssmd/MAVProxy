...
if __name__ == '__main__':
    ...
    parser.add_option("--default-modules", default="log,signing,wp,param,relay,tuneopt,arm,mode,calibration,rc,auxopt,misc,cmdlong,battery,output,layout", help='default module list')
