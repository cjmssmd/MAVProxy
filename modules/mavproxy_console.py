...
class ConsoleModule(mp_module.MPModule):
    def __init__(self, mpstate):
        ...
        mpstate.console.set_status('Heading', 'Hdg ---/---', row=0)
        ...
        mpstate.console.set_status('WP', 'WP --', row=0)
        mpstate.console.set_status('WPDist', 'Distance ---', row=0)
        mpstate.console.set_status('WPBearing', 'Bearing ---', row=0)
        ...
        if mp_util.has_wxpython:
            ...
            # Create some buttons
            self.add_button('MODULE LIST', '# module list')
            self.add_button('ARM', '# arm')
            self.add_button('DISARM', '# disarm')
            self.add_button('MANUAL MODE', '# mode manual')
            self.add_button('AUTO MODE', '# mode auto')
            self.add_button('FRONT YARD A', '# module list')
            self.add_button('FRONT YARD B', '# module list')
            self.add_button('FRONT YARD C', '# module list')
    ...
    def add_button(self, label, command):
        '''add a new button'''
        self.mpstate.console.set_button(label, command, self.button_callback)
    ...
    def button_callback(self, m):
        '''called on button click, expects m to be a MPButton'''
